...
export default function AppfolioWidget () {
  return (
    <>
      <Script
        className='h-full w-full'
        src='https://npdodge.appfolio.com/javascripts/listing.js'
        onLoad={() =>
          Appfolio.Listing({
            hostUrl: 'npdodge.appfolio.com',
            propertyGroup: 'Z-Website-Parkview',
            themeColor: '#676767',
            height: '100%',
            width: '100%',
